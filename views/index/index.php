<div class="row">	
	<div class="col-md-8">
		<div class="box box-solid">
			<div class="box-header with-border">
				<h4 class="box-title">Calendar of Classes</h4>
			</div>
	...
	<div class="col-md-4">
		<div class="box box-solid">
			<div class="box-header with-border">
				<h4 class="box-title">Today's Class(es)</h4>
			</div>
			<div class="box-body">
		    	...
		    	?>
		        <?php else: ?>
				<p class="alert alert-info no-margin">Currently we don't have any class(es) on-going</p>
				<?php endif; ?>
		    </div>
		</div>
		<div class="box box-solid">
			<div class="box-header with-border">
				<h4 class="box-title">Upcoming Class(es)</h4>
			</div>
			<div class="box-body">
		    	...
		    	<?php endforeach; ?>
		        <?php else: ?>
				<p class="alert alert-info no-margin">Currently we don't have any upcoming class(es)</p>
				<?php endif; ?>
			</div>
		</div>
	</div>
