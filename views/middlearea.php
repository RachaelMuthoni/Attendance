<header class="main-header">
  ...
  <a href="<?php echo URL; ?>" class="logo">
    ...
    <span class="logo-mini"><img style="width: 50px" src="<?php echo URL; ?>public/dedan.jpg" /></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="<?php echo URL; ?>public/dedan.jpg" style="width: 50px" /></span>
  </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li<?php echo ($this->menu == "officers") ? ' class="active"': ""; ?>><a href="<?php echo URL; ?>officers"><i class="fa fa-users"></i> <span>Lecturers</span></a></li>
        <?php endif; ?>
        <li<?php echo ($this->menu == "students") ? ' class="active"': ""; ?>><a href="<?php echo URL; ?>students"><i class="fa fa-users"></i> <span>Students</span></a></li>
        <li<?php echo ($this->menu == "events") ? ' class="active"': ""; ?>><a href="<?php echo URL; ?>events"><i class="fa fa-calendar"></i> <span>Classes</span></a></li>
