<div class="row">
	<div class="col-md-12">
		<div class="box box-solid">
					...
					<div class="col-md-7">
						<div class="box box-solid box-info">
							<div class="box-header with-border">
								...
								<p class="no-margin pull-right">Lecturer's Name: <?php echo ucwords(Session::get('firstname') . " " . Session::get('lastname')); ?></p>
							</div>
							<div class="box-body">
			...
			<?php else: ?>
			<p class="alert alert-info">There are no events or classes assigned for you</p>
			<?php endif; ?>
		</div>
	</div>
</div>