		...
		<div class="box box-solid">
			...
			<div class="box-body">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="regnumber" value="<?php echo $this->student['barcode']; ?>" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="mobile" maxlength = "10",value="<?php echo $this->student['mobile']; ?>" />
				</div>
				<div class="form-group">
