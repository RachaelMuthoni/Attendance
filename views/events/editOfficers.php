...
<div class="modal-dialog" style="width: 800px">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Edit Class' Lecturer</h4>
		</div>
		...
		<div class="modal-body">
			...
			<?php else: ?>
				<p class="alert alert-info">There are no lecturers to assign the said event</p>
			<?php endif; ?>
		</div>
		<div class="modal-footer text-right">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			<button type="submit" class="btn btn-success">Assign Lecturer(s)</button>
		</div>
		</form>
	</div>
</div>